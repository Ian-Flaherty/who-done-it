...
export default function QuestionEight() {
  ...
  const handleSubmit = async (e) => {
    ...
    const fields = {
      fields: {
        questioneight: student.fields.questioneight + 1,
      },
    };
    ...
    <>
      ...
      <div>
        ...
        {classmates.map((image) => (
          ...
          <Link to='/Questionnine' onClick={handleSubmit} style={{ display: 'inline-block', width: 170, height: 170, borderRadius: 400 / 2, }}><img style={{ width: 170, height: 170, borderRadius: 400 / 2 }}
            src=
              {image.fields?.image}
            title={image.id}
          /></Link>
