...
export default function QuestionFive() {
  ...
  const handleSubmit = async (e) => {
    ...
    const fields = {
      fields: {
        questionfive: student.fields.questionfive + 1,
      },
    };
  ...
  return (
    <>
      <h1>Who do you think will change the world?</h1>
      <Video />
      <div>
        ...
        {classmates.map((image) => (
          ...
          <Link to='/Questionsix' onClick={handleSubmit} style={{ display: 'inline-block', width: 170, height: 170, borderRadius: 400 / 2, }}><img style={{ width: 170, height: 170, borderRadius: 400 / 2 }}
            src=
              {image.fields?.image}
            title={image.id}
          /></Link>
