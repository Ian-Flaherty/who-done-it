...
export default function QuestionThree() {
  ...
  const handleSubmit = async (e) => {
    ...
    const fields = {
      fields: {
        questionten: student.fields.questionten + 1,
      },
    };
    ...
    <>
      ...
      <div>
        ...
        {classmates.map((image) => (
          ...
          <Link to='/Questioneleven' onClick={handleSubmit} style={{ display: 'inline-block', width: 170, height: 170, borderRadius: 400 / 2, }}><img style={{ width: 170, height: 170, borderRadius: 400 / 2 }}
            src=
              {image.fields?.image}
            title={image.id}
          /></Link>
