...
export default function QuestionFour() {
  ...
  const handleSubmit = async (e) => {
    ...
    const fields = {
      fields: {
        questionfour: student.fields.questionfour + 1,
      },
    };
  ...
  return (
    <>
      <h1>Who has the best Projects?</h1>
      <Video />
      <div>
        ...
        {classmates.map((image) => (
          ...
          <Link to='/Questionfive' onClick={handleSubmit} style={{ display: 'inline-block', width: 170, height: 170, borderRadius: 400 / 2, }}><img style={{ width: 170, height: 170, borderRadius: 400 / 2 }}
            src=
              {image.fields?.image}
            title={image.id}
          /></Link>
