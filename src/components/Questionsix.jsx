...
export default function QuestionSix() {
  ...
  const handleSubmit = async (e) => {
    ...
    const fields = {
      fields: {
        questionsix: student.fields.questionsix + 1,
      },
    };
    ...
    <>
      ...
      <div>
        ...
        {classmates.map((image) => (
          ...
          <Link to='/Questionseven' onClick={handleSubmit} style={{ display: 'inline-block', width: 170, height: 170, borderRadius: 400 / 2, }}><img style={{ width: 170, height: 170, borderRadius: 400 / 2 }}
            src=
              {image.fields?.image}
            title={image.id}
          /></Link>
