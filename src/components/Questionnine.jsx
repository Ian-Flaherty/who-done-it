...
export default function QuestionNine() {
  ...
  const handleSubmit = async (e) => {
    ...
    const fields = {
      fields: {
        questionnine: student.fields.questionnine + 1.
    ...
    <>
      ...
      <div>
        ...
        {classmates.map((image) => (
          ...
          <Link to='/Questionten' onClick={handleSubmit} style={{ display: 'inline-block', width: 170, height: 170, borderRadius: 400 / 2, }}><img style={{ width: 170, height: 170, borderRadius: 400 / 2 }}
            src=
              {image.fields?.image}
            title={image.id}
          /></Link>
