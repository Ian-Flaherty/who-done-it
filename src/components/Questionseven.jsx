...
export default function QuestionSeven() {
  ...
  const handleSubmit = async (e) => {
    ...
    const fields = {
      fields: {
        questionseven: student.fields.questionseven + 1,
      },
    };
  ...
  return (
    <>
      <h1>Who is most likely to become famous?</h1>
      <Video />
      <div>
        ...
        {classmates.map((image) => (
          ...
          <Link to='/Questioneight' onClick={handleSubmit} style={{ display: 'inline-block', width: 170, height: 170, borderRadius: 400 / 2, }}><img style={{ width: 170, height: 170, borderRadius: 400 / 2 }}
            src=
              {image.fields?.image}
            title={image.id}
          /></Link>
