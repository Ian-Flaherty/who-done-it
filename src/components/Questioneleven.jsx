...
export default function QuestionThree() {
  ...
  const handleSubmit = async (e) => {
    ...
    const fields = {
      fields: {
        questioneleven: student.fields.questioneleven + 1,
      },
    };
  ...
  return (
    <>
      <h1>Who is the most interesting classmate?</h1>
      <Video />
      <div>
        ...
        {classmates.map((image) => (
          ...
          <Link to='/Questiontwelve' onClick={handleSubmit} style={{ display: 'inline-block', width: 170, height: 170, borderRadius: 400 / 2, }}><img style={{ width: 170, height: 170, borderRadius: 400 / 2 }}
            src=
              {image.fields?.image}
            title={image.id}
          /></Link>
